...
class DataProviderServiceStub(object):
...
def add_DataProviderServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'dataprovider.DataProviderService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('dataprovider.DataProviderService', rpc_method_handlers)
