...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResiliencyScoreResult) DeepCopyInto(out *ResiliencyScoreResult) {
	*out = *in
	if in.Baseline != nil {
		in, out := &in.Baseline, &out.Baseline
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResiliencyScoreResult.
func (in *ResiliencyScoreResult) DeepCopy() *ResiliencyScoreResult {
	if in == nil {
		return nil
	}
	out := new(ResiliencyScoreResult)
	in.DeepCopyInto(out)
	return out
}
