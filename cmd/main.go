...
func init() {
	...
	utilruntime.Must(krknchaosv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.KrknTargetReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KrknTarget")
		os.Exit(1)
	}
